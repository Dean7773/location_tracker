...
def create_location_map(location: Location, zoom: int = 15) -> str:
...
def create_multi_track_map(tracks: List[Track], zoom: int = 12) -> str:
...
def create_stats_map(locations: List[Location], zoom: int = 12) -> str:
